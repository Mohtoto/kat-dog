      ...
      <div className="row">
        <div className=" flex items-center justify-center min-h-[calc(100vh-81px-187px)]">
          <div className="flex items-center justify-center relative ">
            <div className="lg:w-[300px] lg:h-[300px] rounded-lg bg-transparentPurple rotate-[50deg] absolute w-[250px] h-[250px]"></div>
            <div className="lg:w-[300px] lg:h-[300px] bg-transparentPink rounded-lg rotate-[50deg] absolute -top-38 -left-28 w-[250px] h-[250px]">
